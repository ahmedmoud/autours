                    ...
                    <AutoComplete v-model="form.pickupLoc" :class="'col-md-5'" optionLabel="name"
                        ...
                        <template #option="slotProps">
                            <div class="flex align-items-center">
                                <div>{{ slotProps.option.location }}&nbsp;&nbsp; {{slotProps.option.location_type !== 'Airport' ? slotProps.option.location_type : ''}} &nbsp;&nbsp;<i :class=" slotProps.option.location_type === 'Airport' ? 'fa fa-plane-departure' : slotProps.option.location_type === 'Building' ? 'fa fa-building' : 'fa fa-hotel'"/></div>
                            </div>
                        </template>
