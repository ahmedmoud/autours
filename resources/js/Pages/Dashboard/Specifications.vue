<template>
    <div class="card">
        <div class="card-body">
            ...
            <el-dialog @close="cancelEdit" v-model="openEditDialog" >
                    <form class="mt-5" @submit.prevent="handleEdit">
                        <div class="row">
                            ...
                            <div class="formbold-mb-3 col-3">
                                <label class="formbold-form-label">Select Icon</label>
                                <el-select
                                    size="large"
                                    v-model="form.icon"
                                    filterable
                    ...
                    <span v-if="Array.isArray(scope.row.options)">
                      {{ scope.row.options.join(', ') }}
                        ...
                        <el-table-column align="right">
                            ...
                            <template #default="scope">
                                <el-button size="small"  type="warning" @click="editDialog(scope.$index, scope.row)"
                                ><i class="fa fa-pencil"/></el-button>
