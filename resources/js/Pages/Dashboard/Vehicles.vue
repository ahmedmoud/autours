        ...
        <div class="table d-flex">
            <el-table :data="filterTableData" style="width: 100%" :loading="loading" stripe>
                ...
                <el-table-column v-if="role === 'admin'" label="Supplier">
                    <template #default="scope">
                        <img :src="'/img/' + scope.row.supplier.logo" class="w-100">
                    </template>
                </el-table-column>
            ...
            <div>
              <form @submit.prevent>
                <div class="formbold-mb-3">
                    ...
                    <img v-if="photo?.includes('_')" :src="'/img/vehicles/' + photo"  class="w-100 mb-2" style="border-radius: 15px;">
                    <img v-else-if="data.photo" :src="'/img/vehicles/' + data.photo"  class="w-100 mb-2" style="border-radius: 15px;">
                    <el-select
                      v-model="photo"
                      size="large"
                      filterable
                ...
                <div class="formbold-mb-3">
                    ...
                    <div class="input-with-percent">
                      <input v-model="data.price" type="text" pattern="[0-9]+([,.][0-9]+)?" class="formbold-form-input" />
                ...
                <div class="formbold-mb-3">
                    ...
                    <div class="input-with-percent">
                      <input v-model="data.week_price" type="text" pattern="[0-9]+([,.][0-9]+)?" class="formbold-form-input" />
                      <span class="percent-symbol">$</span>
                    </div>
                </div>
                ...
                <div class="formbold-mb-3">
                    ...
                    <div class="input-with-percent">
                      <input v-model="data.month_price" type="text" pattern="[0-9]+([,.][0-9]+)?" class="formbold-form-input" />
                      <span class="percent-symbol">$</span>
                    </div>
                </div>
                ...
                <div class="formbold-mb-3">
                    ...
                    <div class="input-with-percent">
                      <input v-model="data.year_price" type="text" pattern="[0-9]+([,.][0-9]+)?" class="formbold-form-input" />
                      <span class="percent-symbol">$</span>
                    </div>
                </div>
