                        ...
                        <el-table :data="filterTableData" style="width: 100%" :loading="loading" stripe>
                            ...
                            <el-table-column label="Actions">
                                <template #default="scope">
                                        ...
                                        <el-switch size="large" v-model="tableData[scope.$index].activation" :value="scope.row.activation == true ||  scope.row.activation == 1 ? true : false " @click="changeVehicleStatus(scope.$index)"></el-switch>
                                </template>
                                <template #header>
